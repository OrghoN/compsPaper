...
\newcommand{\mytitle}{Machine Learning based Reconstruction in a Pixellated Liquid Argon Time Projection Chamber}
...
\newcommand{\committeememberA}{Yasar Onel}
...
\longvertspacing
\begin{tightcenter}
Comprehensive Examination Paper \end{tightcenter}
\mylinespacing
\begin{tightcenter}
\mymonth~\myyear
\end{tightcenter}
