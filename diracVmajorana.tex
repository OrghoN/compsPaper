...
According to Dirac's theory, neutrinos have distinct antiparticles, and their masses arise from the Higgs mechanism, similar to other fermions \cite{Gorbar_Miranskiĭ_Shovkovy_Sukhachov_2021}.
...
In this framework, neutrinos are described by Majorana fermions \cite{Majorana_1937}.
...
The Majorana mass term explicitly breaks the lepton number conservation \cite{Babu_Barman_Gonçalves_Ismail_2024}, which is a key difference from the Dirac case.
Lepton number conservation is the principle that the total number of leptons minus antileptons remains constant in a physical process \cite{Griffiths_1987}.
Majorana neutrinos are their own antiparticles \cite{Kayser_2009}, and their mass term is of the form:
